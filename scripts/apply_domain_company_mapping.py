...
def main():
    ...
    company_obj, created = Company.objects.get_or_create(name=mapped, defaults={
        'domain': domain or '',
    ...
    print('Assigned company', company_obj.name, 'to Message id=', msg.id, 'ThreadTracking id=', tt.id)
