...
if user_email:
    ...
    print(f"2. After excluding user email '{user_email}': {applications_week_qs.count()} (removed {before_count - applications_week_qs.count()})")
else:
...
print(f"3. After excluding headhunter companies: {applications_week_qs.count()} (removed {before_count - applications_week_qs.count()})")
...
if headhunter_domains:
    ...
    print(f"4. After excluding headhunter domains: {applications_week_qs.count()} (removed {before_count - applications_week_qs.count()})")
else:
...
company_names = applications_week_qs.values_list('company__name', flat=True).distinct().order_by('company__name')
