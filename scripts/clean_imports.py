...
def is_import_used(import_name: str, content: str, import_line_num: int) -> bool:
    ...
    essential_imports = {
        'django', 'models', 'forms', 'admin', 'Q', 'F', 'Count', 'Sum', 
        'login_required', 'csrf_exempt', 'render', 'redirect', 'JsonResponse',
        'HttpResponse', 'StreamingHttpResponse', 'os', 'sys', 're', 'json',
        'Path', 'datetime', 'timedelta', 'settings'
    }
