...
for name in args.companies:
    ...
    for comp in comp_qs:
        ...
        for tt in tts:
            print('  TT id:', tt.id, 'thread_id:', tt.thread_id, 'sent_date:', tt.sent_date, 'interview_date:', tt.interview_date, 'ml_label:', tt.ml_label, 'ml_confidence:', tt.ml_confidence, 'status:', tt.status, 'company_source:', tt.company_source)
            ...
            for m in msgs:
                ...
                print('    MSG:', m.id, m.msg_id, m.timestamp, m.ml_label, m.sender, subj)
