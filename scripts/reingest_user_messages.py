    ...
    try:
        ...
        for i, msg_ref in enumerate(messages, 1):
            ...
            try:
                ...
                errors += 1
                print(f"❌ [{i}/{len(messages)}] Error processing message ID {msg_id}: {e}")
        ...
        sample_msgs = Message.objects.filter(
        ...
        for msg in sample_msgs:
            ...
            print(f"    Label: {msg.ml_label}, Company: {company_name}, Confidence: {msg.confidence:.2f}")
