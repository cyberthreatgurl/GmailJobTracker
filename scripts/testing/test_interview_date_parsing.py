...
def test_interview_date_parsing():
    ...
    print(f"Test 1 - 'January 15th': {parsed1} (expected {expected1}) {'✓' if parsed1 == expected1 else '✗'}")
    ...
    print(f"Test 2 - 'Monday, January 20, 2026': {parsed2} (expected {expected2}) {'✓' if parsed2 == expected2 else '✗'}")
    ...
    print(f"Test 3 - '01/25/2026': {parsed3} (expected {expected3}) {'✓' if parsed3 == expected3 else '✗'}")
    ...
    print(f"Test 4 - 'next Friday': {parsed4} (expected ~{expected4}) {'✓' if parsed4 >= received_date.date() else '✗'}")
    ...
    print(f"Test 5 - No date (fallback): {parsed5} (expected {expected5}) {'✓' if parsed5 == expected5 else '✗'}")
    ...
    print(f"Test 6 - 'Tuesday, December 17th': {parsed6} (expected {expected6}) {'✓' if parsed6 == expected6 else '✗'}")
