...
def test_indeed_application_override():
    ...
    body = (
        "We'll help you get started. Application submitted. We'd like to discuss the opportunity soon."
    )
    ...
    result = predict_with_fallback(fake_ml_predict, subject, body, sender="indeedapply@indeed.com")
    assert (
