...
with OUT.open("w", encoding="utf-8", newline="") as outf:
    ...
    for msg in qs:
        ...
        ml = predict_subject_type(msg.subject or "", body, sender=(msg.sender or "") if hasattr(msg, "sender") else "")
...
print(f"Wrote disagreements to: {OUT} (rows where stored label != ML prediction for reviewed messages)")
