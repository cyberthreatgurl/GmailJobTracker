...
def manage_domains(request):
    ...
    stats = {
        ...
        "unlabeled": sum(1 for d in all_domains if d not in personal_domains and d not in ats_domains and d not in headhunter_domains and d not in domain_to_company),
